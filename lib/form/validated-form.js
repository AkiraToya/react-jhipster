...
const processOneChild = (_a, { register, setValue, errors, touchedFields, dirtyFields }, child) => {
    var _b;
    var { defaultValues, children, onSubmit, mode } = _a, rest = (0, tslib_1.__rest)(_a, ["defaultValues", "children", "onSubmit", "mode"]);
    ...
    child = react_1.default.cloneElement(child, {
        children: react_1.default.Children.map(child.props.children, (nextChild) => {
            return processOneChild(Object.assign({ defaultValues, children: child.props.children, onSubmit, mode }, rest), { register, setValue, errors, touchedFields, dirtyFields }, nextChild);
        })
    });
    return child;
};
