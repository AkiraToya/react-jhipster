...
function ValidatedInputAutoComplete(_a) {
    var { name, id = name, register, error, isTouched, isDirty, validate, children, className, onChange, onBlur, options, multiple, defaultValue, customOnChange, control } = _a, attributes = (0, tslib_1.__rest)(_a, ["name", "id", "register", "error", "isTouched", "isDirty", "validate", "children", "className", "onChange", "onBlur", "options", "multiple", "defaultValue", "customOnChange", "control"]);
    if (!register) {
    ...
    const { name: registeredName, onBlur: onBlurValidate, onChange: onChangeValidate, ref } = register(name, validate);
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(react_hook_form_1.Controller, { name: registeredName, control: control, render: ({ field }) => react_1.default.createElement(react_select_1.default, Object.assign({ id: id, valid: isTouched && !error, invalid: !!error, innerRef: ref, className: className, onChange: e => {
                    void onChangeValidate(e);
                    onChange && onChange(e);
                }, onBlur: e => {
                    void onBlurValidate(e);
                    onBlur && onBlur(e);
                }, options: options }, multiple ? { isMulti: true } : { isMulti: false }, defaultValue ? { defaultValue: JSON.parse(defaultValue.toString()) } : {}, attributes, field)) }),
        error && react_1.default.createElement(reactstrap_1.FormFeedback, null, error.message)));
}
