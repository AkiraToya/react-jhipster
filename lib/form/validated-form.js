...
const processOneChild = (_a, { register, setValue, errors, touchedFields, dirtyFields, control }, child) => {
    ...
    if (type === "button" || type === reactstrap_1.Button)
        return child;
    const isValidated = type && ((_b = child === null || child === void 0 ? void 0 : child.props) === null || _b === void 0 ? void 0 : _b.name) && ['ValidatedField', 'ValidatedInput', 'ValidatedBlobField', 'ValidatedInputAutoComplete'].includes(type.displayName);
    if (isValidated) {
